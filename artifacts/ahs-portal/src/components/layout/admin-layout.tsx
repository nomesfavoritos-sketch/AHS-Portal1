    ...
    >
      ...
      <div className="px-5 py-5 shrink-0" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="flex items-center gap-3">
          <div
            className="h-10 w-10 rounded-xl flex items-center justify-center shrink-0 font-black text-[11px] tracking-tight"
            style={{ background: "linear-gradient(135deg, #16A34A, #006C35)", color: "#fff", boxShadow: "0 4px 12px rgba(22,163,74,0.40)" }}
          >
            AHS
          </div>
