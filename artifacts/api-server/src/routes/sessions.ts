...
const fmt = (s: typeof admissionSessionsTable.$inferSelect) => ({
  ...
  endDate: s.endDate,
  correctionWindowStart: s.correctionWindowStart ?? null,
  correctionWindowEnd: s.correctionWindowEnd ?? null,
  meritPublicationDate: s.meritPublicationDate ?? null,
  joiningDeadline: s.joiningDeadline ?? null,
  isActive: s.isActive,
  status: s.status,
